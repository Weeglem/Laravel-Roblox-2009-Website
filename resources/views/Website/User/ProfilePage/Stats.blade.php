<div id="UserStatisticsPane">
    <div id="UserStatistics">
        ...
        <div class="Statistic">
            ...
            <div class="Value"><span id="ctl00_cphRoblox_rbxUserStatisticsPane_lFriendsStatistics">0 (1,865 last week)</span></div>
        </div>
        <!--Forum posts-->
        <div class="Statistic">
        ...
        <div class="Statistic">
            ...
            <div class="Value"><span id="ctl00_cphRoblox_rbxUserStatisticsPane_lProfileViewsStatistics">0 (32,904 last week)</span></div>
        </div>
        <!--Place visits-->
        <div class="Statistic">
            <div class="Label"><acronym title="The number of times this user&#39;s place has been visited.">Place Visits</acronym>:</div>
            <div class="Value"><span id="ctl00_cphRoblox_rbxUserStatisticsPane_lPlaceVisitsStatistics">0 (9,041 last week)</span></div>
        </div>
        <!--Kills-->
        <div class="Statistic">
            ...
            <div class="Value"><span id="ctl00_cphRoblox_rbxUserStatisticsPane_lKillsStatistics">0 ( last week)</span></div>
        </div>
    </div>
</div>
